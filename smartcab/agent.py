...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon = 1 / (self.t**2 + self.alpha*self.t)
            # self.epsilon = 1 /(self.t**2 - self.alpha*self.t)
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            # Continue to explore & take random actions whilst epsilon is greater than 0.01 and a random number between 0 and 1.
            if self.epsilon > 0.01 and self.epsilon > random.random():
                action = random.choice(self.valid_actions)
            else:
            # Else, use MaxQ to determine which is the best learned action to take
                valid_actions = []
